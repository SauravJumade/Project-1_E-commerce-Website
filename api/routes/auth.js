...
const encryptedPassword = cryptoJS.AES.encrypt("29102002", process.env.CRYPTOJS_SECRET_KEY).toString();

 userData = [
  {
      name: "Royal Clothings",
      emailid: "RoyalClothings@gmail.com",
  ...
  },
  {
      ...
      password: cryptoJS.AES.encrypt("password2", process.env.CRYPTOJS_SECRET_KEY).toString(),
      isAdmin: true,
      id: 2
  },
  {
      ...
      password: cryptoJS.AES.encrypt("password3", process.env.CRYPTOJS_SECRET_KEY).toString(),
      isAdmin: false,
      id: 3
  },
  {
      ...
      password: cryptoJS.AES.encrypt("password4", process.env.CRYPTOJS_SECRET_KEY).toString(),
      isAdmin: true,
      id: 4
  },
  {
      ...
      password: cryptoJS.AES.encrypt("password5", process.env.CRYPTOJS_SECRET_KEY).toString(),
      isAdmin: false,
      id: 5
  },
  {
      ...
      password: cryptoJS.AES.encrypt("password6", process.env.CRYPTOJS_SECRET_KEY).toString(),
      //isAdmin: true,
      id: 6
  },
];
...
router.post("/login", async (req, res) => {
  ...
  try {
    ...
    const user=userData.find(u=>u.emailid===req.body.email)
      if (!user) {
      ...
      const {password,resetPasswordToken,resetPasswordExpire, ...others} = user
