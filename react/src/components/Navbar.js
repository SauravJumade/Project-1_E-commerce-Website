...
function Navbar() {
  ...
  return (
    <Container>
        <Wrapper>
            <Left>
            <div className="nav-bar" style={{display:"flex",justifyContent:"center",alignItems:"center",padding:"0 30px",height:"40px"}}>
                <div className="nav-logo" style={{display:"flex",alignItems:"center"}}>
                   <Logo><Link onClick={() => redirect("/")} style={link} to="/"><img src='/new_logo.png' alt="logo" style={{width:"110px",height:"110px",borderRadius:"50%",objectFit:"cover"}} /></Link></Logo>
                   <span className="logo-name" style={{marginLeft:"-20px",fontSize:"25px",fontWeight:"bold",color:"black"}}>ROYAL CLOTHINGS</span>
                </div>
            </div>
            </Left>
            <Center>
